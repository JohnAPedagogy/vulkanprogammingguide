QT =
CONFIG += c++17
TARGET = 06_05_declaring_resources
TEMPLATE = app
DEFINES += ENABLE_VALIDATION
SOURCES += ../../ch02/0202_allocator.cpp 06_05_declaring_resources.cpp my_vulkan.cpp
HEADERS += ../../ch02/0201_allocator.h my_vulkan.h
isEmpty(MSYS2_DIR): MSYS2_DIR = $$(MSYS2_DIR)
isEmpty(MSYS2_DIR) { exists(D:/Programs/msys64/mingw64) { MSYS2_DIR = D:/Programs/msys64/mingw64 } else { MSYS2_DIR = C:/Users/JohnAlamina/scoop/apps/msys2/2025-08-30/mingw64 } }
...
CONFIG(debug, debug|release) { DEST_SUBDIR = debug } else { DEST_SUBDIR = release }
