...
{
    VkResult vkr = vk_create_tessellation_pipeline();
    switch (vkr)
    {
    case VK_SUCCESS:
        std::cout << "Tessellation pipeline created successfully.\n";
        break;
    case VK_ERROR_INITIALIZATION_FAILED:
        std::cout << "Warning: Failed to create tessellation pipeline.\n";
        break;
    default:
        std::cout << "Warning! vk_create_tessellation_pipeline error=" << vkr << "\n";
    }
}

void my_run_tessellation()
{
    std::cout << "Tessellation shader stage demonstration (pipeline ready).\n";
}
